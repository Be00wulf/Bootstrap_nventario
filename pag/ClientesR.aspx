<%@ Page Title="Clientes Registrados" Language="C#" MasterPageFile="~/pag/SiteLogin.Master" AutoEventWireup="true" CodeBehind="ClientesR.aspx.cs" Inherits="invent_H.pag.ClientesR" %>
    ...
    <div class="info">
        <main>
            <section class="content-section" aria-labelledby="datatTitle">
                ...
                <div class="row">
                    <div class="col-12">
                        <h1 class="textoResaltado text-center">Clientes 
