...
namespace invent_H.pag
{
    public partial class Clientes : System.Web.UI.Page
    {
        ...
        protected void btnEDITAR_Click(object sender, EventArgs e)
        {
            ...
            string filePath = Server.MapPath("~/txt/Clientes.txt");
            ...
            if (File.Exists(filePath))
            {
                ...
                {
                    MostrarModalConMensaje("¡No se encontró información con el NIT especificado!");
                }
            }
            else
            {
        ...
        protected void ButtonBuscar_Click(object sender, EventArgs e)
        {
            ...
            if (File.Exists(filePath))
            {
                ...
                {
                    MostrarModalConMensaje("¡No existe información con el NIT ingresado!");
                    btnOff();
                }
        ...
        protected void btnGUARDAR_Click(object sender, EventArgs e)
        {
            ...
            if (File.Exists(filePath))
            {
                ...
                foreach (string linea in lineas)
                {
                    ...
                    {
                        prodEncontrado = true;
                        MostrarModalConMensaje("¡Ya existe información con el NIT especificado, intente con otro código!");
                        break;
                    }
                }
