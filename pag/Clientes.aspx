<%@ Page Title="Clientes" Language="C#" MasterPageFile="~/pag/SiteLogin.Master" AutoEventWireup="true" CodeBehind="Clientes.aspx.cs" Inherits="invent_H.pag.Clientes" %>
    ...
    <div class="container mt-4 ">
        <main>
            <section class="content-section" aria-labelledby="inventTitle">
                <h1 id="inventTitle">Ingreso de clientes</h1>

                <div class="row justify-content-center align-items-center mb-3">
                    <div class="col-md-6 mb-3">
                        NIT<label for="TextBoxCodigo" class="alinCentro">:</label>
                        <asp:TextBox ID="TextBoxCodigo" runat="server" CssClass="form-control estilotxtBoxS" type="number" placeholder="Ej: 12AA ó C/F = 00"></asp:TextBox>
                    </div>

                    <div class="col-md-6 mb-3">
                        CLIENTE<label for="TextBoxProducto">:</label>
                        <asp:TextBox ID="TextBoxProducto" runat="server" CssClass="form-control estilotxtBoxS" placeholder="Ej: Luis Lux"></asp:TextBox>
                    </div>
                </div>
                ...
                <div class="row mb-3 justify-content-center align-items-center">
                    <div class="col text-center">
                        ...
                        <asp:TextBox ID="TextBoxBuscar" runat="server" CssClass="form-control d-inline-block w-auto ms-2" type="number" placeholder="Ingresar NIT"></asp:TextBox>
                    </div>
                </div>
